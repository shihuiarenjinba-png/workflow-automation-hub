...
Require-File "THIRD_PARTY_NOTICES.md"
Require-File "SBOM.cyclonedx.json"
Require-File "requirements-lock.txt"
...
$LicenseStatus = "Included; product license was required before ZIP creation"
