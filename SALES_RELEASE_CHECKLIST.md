...
- [x] RC ZIP is created by CI, expanded again, manifest-verified, EXE self-tested, and diagnostics-tested
- [x] RC ZIP SHA-256 sidecar is generated for distributor/customer comparison
- [x] Sales package mode fails closed without LICENSE, final THIRD_PARTY_NOTICES.txt, and exact-commit manual acceptance
...
- [x] GitHub Actions builds a temporary Windows RC from the exact PR head and re-verifies the extracted ZIP
- [ ] Download the latest successful RC artifact and compare the outer ZIP SHA-256 with its sidecar
...
- [ ] Build or test the packaged EXE from a path containing spaces/non-ASCII characters
- [ ] Run Windows Defender/AV scan on the exact candidate ZIP/EXE
- [ ] Choose and provide the formal product LICENSE
- [ ] Manually review exact packaged dependencies and provide final THIRD_PARTY_NOTICES.txt
...
The repository now produces a strongly verified RC package automatically. It is still not sales-approved until the remaining owner-machine, real-Google, formal-license/notice, and exact-commit approval gates are completed.
